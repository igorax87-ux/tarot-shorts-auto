...
def create_overlay(hook, text, title):
    ...
    # ОСНОВНОЙ ТЕКСТ
    ty = y + 200
    for line in wrap_text(text, 28)[:7]:
        shadow_text((W // 2, ty), line, font(48), (255, 250, 255, 255))
        ty += 66
        if ty > H - 450:
            break
    ...
    shadow_text((W // 2, cy + 60), "✨ Бесплатный расклад каждый день", font(40), (200, 150, 255, 255))
    shadow_text((W // 2, cy + 135), "Карта • Нумерология • Таро", font(38), (220, 200, 255, 255))
    shadow_text((W // 2, cy + 220), "@numer_taro_bot", font(50), (255, 215, 60, 255))
    shadow_text((W // 2, cy + 300), "👇 Ссылка в описании канала", font(36), (180, 220, 255, 255))
...
def main():
    ...
    prompts = {
        "card": f"Карта Таро дня — {card}. Напиши мистическое послание. Максимум 3 предложения. Только русский.",
        "numerology": f"Нумерология на {today}. Укажи число дня и его значение. Максимум 3 предложения. Только русский.",
        "tarot": "Расклад Таро: прошлое, настоящее, будущее. По одному предложению. Только русский. Мистично.",
        "stars": f"Прогноз звёзд на {today}. Максимум 3 предложения. Только русский. Мистично.",
    }
